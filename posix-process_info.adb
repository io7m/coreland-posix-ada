package body POSIX.Process_Info is
  ...
  is
    function C_Set_User_ID (User_ID : User_DB.User_ID_t)
      return User_DB.User_ID_t;
  ...
  procedure Set_Effective_User_ID
    (User_ID     : in User_DB.User_ID_t;
     Error_Value : out Error.Error_t)
  is
    function C_Set_Effective_User_ID (User_ID : User_DB.User_ID_t)
      return User_DB.User_ID_t;
  ...
  procedure Set_Group_ID
    (Group_ID     : in User_DB.Group_ID_t;
     Error_Value : out Error.Error_t)
  is
    function C_Set_Group_ID (Group_ID : User_DB.Group_ID_t)
      return User_DB.Group_ID_t;
  ...
  procedure Set_Effective_Group_ID
    (Group_ID     : in User_DB.Group_ID_t;
     Error_Value : out Error.Error_t)
  is
    function C_Set_Effective_Group_ID (Group_ID : User_DB.Group_ID_t)
      return User_DB.Group_ID_t;
